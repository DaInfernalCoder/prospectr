...
const features = [
  ...
  },
  {
    ...
    description:
      "Keep track of all your leads in one place. Monitor connection status, conversation history, and export your leads to CSV or CRM.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    title: "Analytics",
    description:
      "Get detailed insights into your campaign performance. Track acceptance rates, response rates, and optimize your outreach strategy.",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
